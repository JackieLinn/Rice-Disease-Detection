...
if __name__ == '__main__':
    model_path = '/root/autodl-tmp/Rice-Disease-Detection/rice-disease-detection/yolo11-original/train/weights/best.pt'
    model = YOLO(model_path)
    result = model.val(data='/root/autodl-tmp/Rice-Disease-Detection/data.yaml',
                       split='test',
                       imgsz=640,
                       batch=128,
